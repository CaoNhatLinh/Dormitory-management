...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.rent-btn').forEach(button => {
        button.addEventListener('click', function(event) {
            ...
            const quantityAvailable = parseInt(deviceRow.querySelector('td:nth-child(3)').innerText); // Số lượng tồn kho
            const originalPrice = parseInt(deviceRow.querySelector('td:nth-child(4)').innerText.replace(/[^0-9]/g, '')); // Giá gốc
