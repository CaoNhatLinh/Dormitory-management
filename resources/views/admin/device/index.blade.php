                    ...
                    <div class="ibox-title d-flex justify-content-between align-items-center">
                        ...
                        <div class="search-container">
                            <form class="search-bar" action="{{ route('device.search') }}" method="GET">
                                <input type="text" name="keyword" class="form-control" placeholder="Tìm kiếm thiết bị...">
                            ...
                            <table id="deviceTable" class="table table-stripped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="text-size-lg me-2" href="{{route('device.editView', $device->device_id)}}">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a class="text-size-lg me-2" href="{{ route('device.delete', $device->device_id) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa thiết bị này không?');">
                                                <i class="fa  fa-trash"></i>
                                            </a>
                                            <a class="text-size-lg me-2" href="#">
                                                <img style="width:24px;height:24px;margin-bottom:8px" src="{{ asset('images/rent.png') }}" alt="">
                                            </a>
                                        </td>
                                    </tr>
                                    @endforeach
